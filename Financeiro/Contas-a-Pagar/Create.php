...
try {
    ...
    // Inserir categoria
    $sql = "INSERT INTO financeiro_contas_a_pagar (nome, descricao, categoria, valor, data_vencimento, data_pagamento) VALUES (:nome, :descricao, :categoria, :valor, :data_vencimento, :data_pagamento)";
