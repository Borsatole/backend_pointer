        ...
        return [
            "contas_a_pagar" => [
                ...
                "variacao_periodo_anterior" => [
                    ...
                    "valor_anterior" => $this->formatarMoeda($relacaoPeriodo['valor_anterior'])
                ],
                "icone" => "receipt",
                "cor" => "orange"
            ],
            "contas_pagas" => [
                ...
                "descricao" => "Contas quitadas no período",
                "valor_total" => $contasPagas['total'],
                "valor_formatado" => $this->formatarMoeda($contasPagas['total']),
                "percentual_total" => $calcularPercentual($contasPagas['quantidade']),
                "icone" => "check_circle",
                "cor" => "green"
            ],
            "contas_pendentes" => [
                ...
                "descricao" => "Contas a vencer ainda não pagas",
                "valor_total" => $contasPendentes['total'],
                "valor_formatado" => $this->formatarMoeda($contasPendentes['total']),
                "percentual_total" => $calcularPercentual($contasPendentes['quantidade']),
            ...
            "contas_atrasadas" => [
                ...
                "descricao" => "Contas vencidas não pagas - URGENTE!",
                "valor_total" => $contasAtrasadas['total'],
                "valor_formatado" => $this->formatarMoeda($contasAtrasadas['total']),
                "percentual_total" => $calcularPercentual($contasAtrasadas['quantidade']),
                "prioridade" => "alta",
                "icone" => "warning",
                "cor" => "red"
            ]
