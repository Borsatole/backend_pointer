...
try {
    ...
    $sqlTotal = "SELECT COUNT(*) FROM financeiro_contas_a_receber $where";
    ...
    // Consulta paginada
    $sql = "SELECT * FROM financeiro_contas_a_receber $where ORDER BY valor DESC LIMIT :limite OFFSET :offset";
